...
export function Footer() {
  return (
    <Container className="footer">
      <a href="https://github.com/FaisalZaid786" className="logo">
      ...
      <div className="social-media">
        ...
        <a
          href="https://api.whatsapp.com/send/?phone=%2B918051941891&text=Hello,+Faisal+!!"
          target="_blank"
          rel="noreferrer"
        >
