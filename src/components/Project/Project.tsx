      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>SocialSphere – Connect, Share, Engage
              </h3>
              <p>Developed SocialSphere, a fully responsive and feature-rich social media platform inspired by Instagram, using React.js, Redux, Firebase, and Tailwind CSS. Designed for seamless performance, scalability, and user engagement, it allows users to sign up, create profiles, share posts, and interact in real time.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>MongoDB</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>SwiftMail – A Modern Email Client</h3>
            <p>SwiftMail is a feature-rich and fully functional email client, designed to deliver a fast, secure, and seamless email experience. Inspired by Gmail, it enables users to send, receive, and manage emails effortlessly. SwiftMail ensures high performance, real-time updates, and a responsive design that works across all devices.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>CodeMate – Connect & Code in Real Time</h3>
              <p>CodeMate is a real-time collaborative code editor designed to facilitate seamless coding sessions among multiple developers. Built with React.js, Node.js, WebSockets, and the Monaco Editor, it offers a robust platform for synchronized code editing, making it ideal for pair programming, coding interviews, and collaborative learning.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
